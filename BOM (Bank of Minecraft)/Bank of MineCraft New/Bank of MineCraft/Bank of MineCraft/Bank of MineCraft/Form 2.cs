...
namespace Bank_of_MineCraft
{
    ...
    {
        //username, addy, and pstlcd strings 
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            //Three if statments for checking if the boxes are null or empty, show these messages:
        ...
        {
            //enable secure password view using the defult password character *
            label3.Visible = true;
