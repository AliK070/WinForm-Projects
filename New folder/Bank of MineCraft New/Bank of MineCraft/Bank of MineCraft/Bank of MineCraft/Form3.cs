...
namespace Bank_of_MineCraft
{
    ...
    {
        //Note to self, start using regions, a better way of organizing this code. Delete useless events for next times project.
        ...
        private void btnTransfer_Click(object sender, EventArgs e)
        {
            ...
            //Calling transfer function, clean way of doing this. (Just for fun)
            Transfer();
        }
        ...
        private void Transfer()
        {
            ...
            //TryParse checks if the provided value is double or not, if it is not a double it would return $0, otherwise it will convert value into double.
           // double input = double.Parse(txtAmount.Text); -> Original Code
            double input = 0;
            bool isdouble = double.TryParse(txtAmount.Text, out input);
            ...
            if (cbfrom.SelectedIndex == 2 && cbto.SelectedIndex == 1)
            {
                ...
                lblSa.Text = "$" + savings.ToString();
                lblCa2.Text = "$" + checking_two.ToString();
                MessageBox.Show("You have sucsessfully transfered $" + input + " from Savings Account to Checking Account.");
            }
            ///
            /////////////////////////////////////////////////////////
        ...
        private void cbto_SelectedIndexChanged(object sender, EventArgs e)
        {
            /*Else if statments to see if the selected index is equal to three, if so it will display
             the Payees label and its textbox. Also changes btn height looks nicer
             */
        ...
        {
            MessageBox.Show(@"From the Bank of Minecraft, your cheques have been ordered to " + lbladd.Text + " at " + lblpst.Text + ".");
            btnorder.Enabled = false;
        }
