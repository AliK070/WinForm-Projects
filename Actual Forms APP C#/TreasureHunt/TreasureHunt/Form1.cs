...
namespace TreasureHunt
{
    public partial class Form1 : Form
    {
        ...
        public void TNTclick()
        {
            ...
            {
                h1.Visible = false;
                MessageBox.Show("You have ignited the first TNT! Stay away from the other three!");
            }
            else if (lives == 2)
            {
                h2.Visible = false;
                MessageBox.Show("You have ignited the second TNT! Stay away from the other two!");
            }
            else if (lives == 1)
            {
                h3.Visible = false;
                MessageBox.Show("You have ignited the third TNT! Stay away from the last one!");
            }
            else if (lives == 0)
            {
                h4.Visible = false;
        ...
        public void EMclick()
        {
            ...
            {
                e1.Visible = true;
                MessageBox.Show("You have found the first Emerald! Only two more to go!");
            }
            else if (emerald == 2)
            {
                e2.Visible = true;
                MessageBox.Show("You have found the second Emerald! Only one more to go!");
            }
            else if (emerald == 3)
            {
                e3.Visible = true;
                MessageBox.Show("You have found the third Emerald!");
